...
if __name__ == '__main__':
    ...
    person.falls_ill.append(call_doctor)    #Subscribing to an event

    person.catch_a_cold()                   #Event occurs

    # and you can remove subscriptions too
    person.falls_ill.remove(call_doctor)    #unsubscibing from an event
    person.catch_a_cold()                   #event occurs
